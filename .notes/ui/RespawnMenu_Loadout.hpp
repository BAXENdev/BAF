////////////////////////////////////////////////////////
// GUI EDITOR OUTPUT START (by BAXENATOR, v1.063, #Nokahu)
////////////////////////////////////////////////////////

class BAX_RespawnLoadout_Title: RscText
{
	idc = 1000;
	text = "Select Loadout (CTRL + V)"; //--- ToDo: Localize;
...
class BAX_RespawnLoadout_Background: RscText
{
	idc = 1001;
	x = 31.5 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X;
...
class BAX_RespawnLoadout_Selection: RscText
{
	idc = 1002;
	text = "(No Loadout Selected)"; //--- ToDo: Localize;
