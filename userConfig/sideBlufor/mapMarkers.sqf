...
SET_GROUP_COLOR("Alpha 1-1", COLOR_PURPLE); // This passes the purple color array
SET_GROUP_ICON("Alpha 1-1", INF); // This passes a keyword for the standard groupMarkerSystem
SET_GROUP_ICON("Alpha 1-1", ICON_INF(o)); // This passes a texture path, in this case an opfor infantry icon
