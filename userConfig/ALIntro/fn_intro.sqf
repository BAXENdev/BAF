// Credit: https://www.youtube.com/@aliascartoons
// by ALIAS
...
_txt_1 = ["PERICULUM",20,"center","3","#618540"] execVM "AL_intro\txt_display.sqf";
// -------------------------------------
_firstshot = [cam1, cam2, target1, 10, 1, 1, false, 0, 0, 0,FALSE] execVM "AL_intro\camera_work.sqf";
waitUntil {scriptdone _firstshot};

// text
_txt_2 = ["Presented by Online Combat Battalion",10,"center_bottom","1","#FFFFFF"] execVM "AL_intro\txt_display.sqf";
// -------------------------------------
_secondshot = [cam3, cam4, target2, 22, 2, 2, true, 0, 0, 0,FALSE] execVM "AL_intro\camera_work.sqf";
waitUntil {scriptdone _secondshot};

_thirdshot = [cam5, cam6, target3, 10, 1, 1, false, 0, 0, 0,TRUE] execVM "AL_intro\camera_work.sqf";
