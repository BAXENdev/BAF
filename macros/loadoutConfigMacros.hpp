...
if (isNil #TAG_REGISTRY) then { TAG_REGISTRY = []; }; \
...
#define LO_SET_ENGINEER(SUFFIX_LOADOUT) LOADOUT_TRAITS(SUFFIX_LOADOUT) set [1,1]s
...
#define CL_ADD_ARSENAL_ITEMS(SUFFIX_CLASS,ITEM_ARRAY) BAF_INIT_fnc_addItemsToArsenal;
