...
#define FACTION_ARSENAL() baf_arsenal_##FACTION_ID
#define LOADOUT_ARSENAL(SUFFIX_LOADOUT) baf_arsenal_##FACTION_ID##_##SUFFIX_LOADOUT
#define CLASS_ARSENAL(SUFFIX_CLASS) baf_arsenal_##FACTION_ID##_##SUFFIX_CLASS
...
#define FA_ADD_WHITELIST_ITEM(ELEMENTS) [(FACTION_ARSENAL() select 0),ELEMENTS,true] call BAF_fnc_appendElements
#define FA_ADD_BLACKLIST_ITEM(ELEMENTS) [(FACTION_ARSENAL() select 1),ELEMENTS,true] call BAF_fnc_appendElements
#define LO_ADD_WHITELIST_ITEM(SUFFIX_LOADOUT,ELEMENTS) [(LOADOUT_ARSENAL(SUFFIX_LOADOUT) select 0),ELEMENTS,true] call BAF_fnc_appendElements
#define LO_ADD_BLACKLIST_ITEM(SUFFIX_LOADOUT,ELEMENTS) [(LOADOUT_ARSENAL(SUFFIX_LOADOUT) select 1),ELEMENTS,true] call BAF_fnc_appendElements
#define CL_ADD_WHITELIST_ITEM(SUFFIX_CLASS,ELEMENTS) [(CLASS_ARSENAL(SUFFIX_CLASS) select 0),ELEMENTS,true] call BAF_fnc_appendElements
#define CL_ADD_BLACKLIST_ITEM(SUFFIX_CLASS,ELEMENTS) [(CLASS_ARSENAL(SUFFIX_CLASS) select 1),ELEMENTS,true] call BAF_fnc_appendElements
