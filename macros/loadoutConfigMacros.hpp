...
#define CREATE_LOADOUT(SUFFIX_LOADOUT,DISPLAY_NAME,LOADOUT_ARRAY) \
    LOADOUT_REGISTRY() pushBack [#LOADOUT_VARIABLE(SUFFIX_LOADOUT),DISPLAY_NAME]; \
...
#define CREATE_CLASS(SUFFIX_CLASS,DISPLAY_NAME,SUFFIX_LOADOUT) \
    CLASS_REGISTRY() pushBack [#CLASS_VARIABLE(SUFFIX_CLASS),DISPLAY_NAME]; \
...
#define CREATE_CRATE(SUFFIX_CRATE,DISPLAY_NAME) \
    CRATE_REGISTRY() pushBack [#CRATE_VARIABLE(SUFFIX_CRATE),DISPLAY_NAME]; \
